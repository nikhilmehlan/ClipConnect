...
import { setCoverImage } from "@/store/UserSlice.js";
    ...
    <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
      <DialogTrigger asChild>
        <button onClick={() => setDialogOpen(true)}>
          <IoCloudUploadOutline size={40} className="text-gray-800" />
        </button>
      </DialogTrigger>
      <DialogContent className="bg-black text-white">
        <DialogTitle className="text-white">Edit Cover Image</DialogTitle>
